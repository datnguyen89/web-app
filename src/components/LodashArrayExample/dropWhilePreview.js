...
const DropWhilePreview = props => {

  return (
    <>
      <WhiteBoxShadow margin={'15px'}>
        <Title level={4}>_.dropWhile(array, [predicate=_.identity])</Title>
...
_.dropWhile(users, <span style="color: #0000aa">function</span>(o) { <span style="color: #0000aa">return</span> !o.active; });
<span style="color: #aaaaaa; font-style: italic">// =&gt; objects for [&#39;pebbles&#39;]</span>
 
<span style="color: #aaaaaa; font-style: italic">// The \`_.matches\` iteratee shorthand.</span>
_.dropWhile(users, { <span style="color: #aa5500">&#39;user&#39;</span>: <span style="color: #aa5500">&#39;barney&#39;</span>, <span style="color: #aa5500">&#39;active&#39;</span>: <span style="color: #0000aa">false</span> });
<span style="color: #aaaaaa; font-style: italic">// =&gt; objects for [&#39;fred&#39;, &#39;pebbles&#39;]</span>
 
<span style="color: #aaaaaa; font-style: italic">// The \`_.matchesProperty\` iteratee shorthand.</span>
_.dropWhile(users, [<span style="color: #aa5500">&#39;active&#39;</span>, <span style="color: #0000aa">false</span>]);
<span style="color: #aaaaaa; font-style: italic">// =&gt; objects for [&#39;pebbles&#39;]</span>
 
<span style="color: #aaaaaa; font-style: italic">// The \`_.property\` iteratee shorthand.</span>
_.dropWhile(users, <span style="color: #aa5500">&#39;active&#39;</span>);
<span style="color: #aaaaaa; font-style: italic">// =&gt; objects for [&#39;barney&#39;, &#39;fred&#39;, &#39;pebbles&#39;]</span>
        ...
        <Tabs defaultActiveKey="2">
          ...
          <TabPane tab="Vn" key="2">
            Tạo 1 mảng mới xóa đi n phần tử từ đầu, hàm truyền vào sẽ chạy mỗi lần lặp
          </TabPane>
        </Tabs>
      </WhiteBoxShadow>
    </>
...
DropWhilePreview.propTypes = {}

export default DropWhilePreview